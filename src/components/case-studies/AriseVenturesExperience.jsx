      ...
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
          <motion.div style={{ opacity: contentOpacity, y: contentY }} className="w-full max-w-4xl px-6 md:px-12 text-center flex flex-col items-center pointer-events-auto">
            ...
            <p className="text-white/90 font-normal text-[15px] md:text-[17px] lg:text-lg max-w-3xl mx-auto leading-relaxed md:leading-relaxed font-secondary">
              {content}
            </p>
          </motion.div>
        </div>
        ...
        <div className="py-16 md:py-20 px-6 md:px-12 max-w-[1400px] mx-auto relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
            ...
            >
              ...
              <div className="space-y-8 text-white/95 font-normal text-[15px] md:text-[17px] lg:text-lg leading-relaxed font-secondary">
