 ...
 * (perspective + preserve-3d + rotateY/translateZ). The panel reaching front-center
 * is the active focus (enlarges, sharpens, brightens, glows, video/gif auto-plays);
 * neighbours stay visible but softer + blurred; far panels recede and fade.
 *
 * Unlike the circular bead hero, each panel keeps the media's EXACT aspect ratio
 * and EXACT format (image / gif / video) straight from Sanity — rectangles stay
 * rectangles, squares stay squares. Cursor parallax + endless smooth twirl.
 *
 * Props: media = normalized items ({ url, alt, isGif, isVideo, source, key }).
 */
