      ...
      <div className="relative z-20 max-w-[1400px] mx-auto px-4 md:px-8 py-24 flex flex-col gap-6">
              ...
              <div className="relative rounded-[28px] md:rounded-[36px] overflow-hidden shadow-[0_12px_80px_rgba(99,102,241,0.25),0_0_0_1px_rgba(129,140,248,0.15)]"
                ...
                <div className="relative z-10 p-8 md:p-14 lg:p-16 flex flex-col md:flex-row gap-8 md:gap-14 items-start">
                  ...
                  <div className="flex-1 flex flex-col gap-6">
                    ...
                    {/* Main text */}
                    <p className="text-[15px] md:text-[17px] lg:text-lg font-secondary leading-relaxed text-white/95 tracking-wide">
                      {content.about}
                    </p>
        ...
        <div className="w-full mt-32 relative z-20 flex flex-col gap-20 md:gap-32 px-4 md:px-0">
          ...
          <div className="relative w-full min-h-[50vh] flex items-center">
            ...
            >
              ...
              <p className="text-[15px] md:text-[17px] lg:text-lg font-secondary leading-relaxed text-white/95 tracking-wide drop-shadow-2xl">
                {content.problem}
              </p>
            </motion.div>
          </div>
          ...
          <div className="relative w-full min-h-[40vh] md:min-h-[50vh] flex items-center justify-end">
            ...
            >
              ...
              {content.solution1 && (
                <p className="text-[15px] md:text-[17px] lg:text-lg font-secondary leading-relaxed text-white/95 tracking-wide drop-shadow-2xl mb-8">
                  {content.solution1}
                </p>
              )}
              {content.solution2 && (
              ...
              {stats.map((stat, index) => (
                <React.Fragment key={`${stat.label || stat.value}-${index}`}>
                  ...
                  >
                     ...
                     {stat.value && <p className="text-[15px] md:text-[17px] lg:text-lg text-white/60 font-secondary leading-relaxed font-light">{stat.value}</p>}
                  </motion.div>
                </React.Fragment>
              ))}
           </div>
        ...
        {(outcomeHeading || outcomeText) && (
          ...
          >
            ...
            {outcomeText && (
              <p className="text-[15px] md:text-[17px] lg:text-lg text-white/70 font-secondary max-w-3xl mx-auto leading-relaxed font-light">
                {outcomeText}
              </p>
            )}
