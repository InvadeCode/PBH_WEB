  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-start pointer-events-none pl-6 md:pl-8 lg:pl-10 xl:pl-12 overflow-visible">
          <motion.div
  ...
  return (
    <div className="w-[100vw] relative left-1/2 -translate-x-1/2 mt-32 z-20">
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] bg-teal-500/8 blur-[120px] rounded-full pointer-events-none" />
    ...
    <div className="relative w-full pl-8 md:pl-12">
      ...
      <div className="mb-10 flex items-center gap-4 overflow-hidden relative z-10">
        ...
        <motion.h3 
          ...
          className={`text-xl md:text-2xl font-primary tracking-tight ${activeData.textColor}`}
        >
          {activeData.subtitle}
        </motion.h3>
      </div>
      ...
      {/* The Paragraphs */}
      <div className="flex flex-col gap-8 text-[16px] md:text-[17px] font-secondary leading-[1.8] font-light text-[#cbd5e1]">
