...
const StrategicEngine = ({ navigate }) => {
  ...
  const submitLead = async (e) => {
    ...
    const clientHtmlContent = htmlContent
      .replace("Hi Team,", `Hi ${leadForm.name},`)
      .replace(`A new Scope of Work has been generated by <strong>${leadForm.name}</strong> from <strong>${leadForm.company}</strong>.`, `Thank you for completing the Scope Builder.`)
      .replace(`Please find their detailed diagnostic responses and selected deliverables attached in both PDF and Excel formats.`, `Please find your detailed diagnostic responses and selected deliverables attached as a PDF snapshot.`)
      .replace("New Scope Builder Lead", "Your Scope Snapshot");
