...
const StrategicEngine = ({ navigate }) => {
  ...
  const submitLead = async (e) => {
    ...
    const clientHtmlContent = htmlContent
      ...
      .replace(`A new Scope of Work has been generated by <strong>${leadForm.name}</strong> from <strong>${leadForm.company}</strong>.`, `Thank you for completing the Scope Builder. Here is a copy of your submitted diagnostic responses and selected deliverables.`)
      .replace("New Scope Builder Lead", "Your Scope Snapshot");
      
    const clientEmailPromise = sendEmailViaResend(clientSubject, clientHtmlContent, attachments, leadForm.email);
